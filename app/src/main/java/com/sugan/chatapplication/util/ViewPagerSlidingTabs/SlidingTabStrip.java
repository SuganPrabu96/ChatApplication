...
package com.sugan.chatapplication.util.ViewPagerSlidingTabs;
    ...
    public void setTabTitlesTextColor(int selectedPosition) {
        for (int i = 0; i < getChildCount(); i++) {
            if (TextView.class.isInstance(getChildAt(i))) {
                ((TextView) getChildAt(i)).setTextColor((selectedPosition == i) ? getTabColorizer().getIndicatorColor(i) : Color.argb(255,0,0,0)  );
            }
        }
    }
